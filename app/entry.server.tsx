...
<body>
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://*.replay.io https://auth.nut.new https://auth.builder.replay.io https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://widget.intercom.io https://api.intercom.io https://api-iam.intercom.io wss://*.intercom.io https://telemetry.replay.io https://*.github.com https://*.githubusercontent.com https://cdn.segment.com https://api.segment.io https://va.vercel-scripts.com https://vitals.vercel-insights.com https://*.lgrckt-in.com http://*.ts.net",
