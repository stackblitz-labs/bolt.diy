...
import { forwardRef, type ForwardedRef, useCallback, memo } from 'react';
import { Checkbox } from '~/components/ui/Checkbox';

interface HistoryItemProps {
  item: ChatHistoryItem;
  onDelete?: (event: React.UIEvent, item: ChatHistoryItem) => void;
  ...
  ({
    ...
    const handleDeleteClick = useCallback(
      (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        ...
        if (onDelete) {
          onDelete(event as unknown as React.UIEvent, item);
        }
      },
      [onDelete, item],
    );
