...
const AmplifyIcon = () => (
  <svg viewBox="0 0 24 24" className="w-4 h-4">
    <path fill="currentColor" d="M12.975 14.774h4.743L13.97 3.328a.614.614 0 0 0-1.097-.008L8.353 11.75a.614.614 0 0 0 .549.898h2.992l-4.442 7.53a.614.614 0 0 0 .915.78l10.592-10.592a.614.614 0 0 0-.435-1.05h-5.549z"/>
  </svg>
);
