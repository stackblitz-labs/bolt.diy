...
export const LoadOlderMessagesButton = memo(
  ({ onLoadOlder, loading = false, disabled = false, error, olderCount }: LoadOlderMessagesButtonProps) => {
    return (
      <div className="flex justify-center py-4">
        ...
        >
          {loading ? (
            ...
            <span className="text-bolt-elements-textError">Failed to load. Click to retry.</span>
          ) : (
            <span>
              Load older messages
