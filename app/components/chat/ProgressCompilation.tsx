...
export default function ProgressCompilation({ data: _data }: { data?: ProgressAnnotation[] }) {
  return null;
  ...
  /*
   *     // Filter out "Response Generated" message for cleaner UI
   *     if (x.label === 'response' && x.status === 'complete') {
   *       return;
   *     }
   */
